...
const handleNavigate = (url) => {
  ...
  return (
    <div className= ' home-container home-container1' style={{width: '47%', marginTop: '7%', backgroundColor: '#0b0b0b', marginLeft:'auto', marginRight: 'auto', color: 'white', borderRadius: '4px'}}>
